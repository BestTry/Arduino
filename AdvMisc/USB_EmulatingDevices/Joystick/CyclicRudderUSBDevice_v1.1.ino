...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
// 2020-11-16 Versio 1.1 Prototype version on protoboard breadboard.  Replace the Arduino Leonardo with the Arduino 'Micro' a significantly reduced 
...
// -------------------------------------------------------------------------------------------------------------------------------------------------------
// 
// Documentation for making cable                           Red      White     Green     N/A      Black
...
const bool testAutoSendMode = true;               // Set 'Send Mode' to true to test "Auto Send" mode or              
                                ...
                                // Variable Definitions to Arduino 'Micro' pin numbers for push-button switches
