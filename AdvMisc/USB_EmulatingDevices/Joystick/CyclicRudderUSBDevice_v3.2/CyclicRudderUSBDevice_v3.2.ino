...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------
// ---------------------------------------------------------------------------------------------------------------------------------------------------------
//  Diagram shows pin details of the DB-15 connector mounted on the Cyclic bulkhead for transmitting the Anti-Torque' Pedals signal values  
////                                       Looking at the face of the DB-15 receptacle connector:  All pins are N/C unless otherwise noted   
