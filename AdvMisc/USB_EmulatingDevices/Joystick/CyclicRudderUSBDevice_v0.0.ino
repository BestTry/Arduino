...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
// 2020-11-08 Versio 0.0  Original tested Prototype version on protoboard breadboard. ----   Tom Ricci
//--------------------------------------------------------------------------------------------------------------------------------------------------------
...
const bool testAutoSendMode = false;              // Set 'Send Mode' to true to test "Auto Send" mode or              
