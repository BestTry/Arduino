...
// 2020-11-25 Versio 3.0 Prototype version on protoboard breadboard.  Replace the Arduino Leonardo with the Arduino 'Pro Micro' a significantly reduced 
// real estate micro-controller that is compatible with its larger big brother version. ********** This version is for the 'Pro Micro"  ----   Tom Ricci
//----------------------------------------------------------------------------------------------------------------------------------------------------------
...
// --------------------------------------------------------    Start / Pause Execution   ------------------------------------------------------------------                                               
  if (digitalRead(A3) != 0)                  // System Disabled if 'A3' is found HIGH - LED indicator is 'off' when sensor polling is not enabled
  { digitalWrite(LED_BUILTIN, 0); return; }  // Code runs in this tight loop when 'A5' is HIGH   
  digitalWrite(LED_BUILTIN, 1);              // Ground 'A3' to fall out of loop and begin code - LED indicator 'on' and sensor polling begins  */
// --------------------------------------------------------------------------------------------------------------------------------------------------------                                                                                                                 
/* ****************************************************************************************************************************************************** */
